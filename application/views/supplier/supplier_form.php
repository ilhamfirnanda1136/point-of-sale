                    ...
                    <div class="col-lg-12">
                        <div class="card mt-5">
                            <div class="card-header">
                                <strong class="card-title"><?=ucfirst($page)?> supplier</strong>
                                <div class="pull-right">
                                    <a href="<?=site_url('supplier')?>" class="btn-primary btn btn-md"><i class="fa fa-undo"></i> BACK</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div id="pay-invoice">
                                    <div class="card-body">
                                 <?php echo form_open_multipart('supplier/proses')?>
                                        <div class="form-group ">
                                            <label for="nama" class="form-control-label">Nama * (tidak boleh kosong)</label>
                                            <input type="hidden" name="id" value="<?=$baris->idsupplier?>"> 
                                            <input type="text" id="nama" name="nama" placeholder="Masukkan nama Lengkap" class="form-control <?=form_error('nama') ? 'is-invalid':null ?>" value="<?= $baris->nama_supplier ?>">
                                            <?=form_error('nama')?>
                                        </div>
                                        <div class="form-group">
