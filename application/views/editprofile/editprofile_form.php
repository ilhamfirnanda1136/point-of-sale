                    ...
                    <div class="col-lg-12">
                        <div class="card mt-5">
                            <div class="card-header">
                                <strong class="card-title">Edit Profil User</strong>
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                 <?php echo form_open_multipart('gantiprofile/proses')?>
                                        ...
                                        <div class="form-group <?=form_error('password') ? 'has-error':null ?>">
                                            <label for="name">PASSWORD</label><small>(Biarkan kosong jika tidak diganti)</small>
